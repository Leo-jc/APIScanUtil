...
# 包上级目录（apiScan/），用于解析本地默认路径
_PKG_PARENT = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

# ---------------------------------------------------------------------------
# 默认路径（可通过 CLI 参数覆盖；已本地化到 apiScan/）
# ---------------------------------------------------------------------------
DEFAULT_SDK_ROOT = r"D:\Application\DevEco Studio\sdk\default"
DEFAULT_KNOWLEDGE_ROOT = os.path.join(_PKG_PARENT, "knowledge")
DEFAULT_PROJECT = r"D:\Projects\APIScanUtil\thirdLibrary\FluidLayout\ohos_hardemo"
DEFAULT_OUT_DIR = os.path.join(_PKG_PARENT, "output")
