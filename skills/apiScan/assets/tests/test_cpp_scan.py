...
HERE = os.path.dirname(os.path.abspath(__file__))            # assets/tests/
ASSETS = os.path.dirname(HERE)                                # assets/
SKILL_ROOT = os.path.dirname(ASSETS)                          # apiScan/
SCRIPTS = os.path.join(SKILL_ROOT, "scripts")                 # apiScan/scripts/
...
def test_scanner_no_cpp_fallback():
    ...
    s = Scanner(project=FIXTURE, knowledge_root=KNOWLEDGE,
                out_dir=os.path.join(SKILL_ROOT, "_test_out_no_cpp"),
